...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "lighthouse" because\n';
  ...
  $wnd.__gwt_activeModules['lighthouse'] = {
 ...
 * "/lighthouse.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['lighthouse'].superdevmode = true;

  var expectedSuffix = '/lighthouse.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + lighthouse + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:lighthouse';
  var devModeSessionKey = '__gwtDevModeSession:lighthouse';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9996';
  var nocacheUrl = serverUrl + '/lighthouse/lighthouse.nocache.js';
  ...
  $wnd.__gwt_activeModules['lighthouse'].canRedirect = true;
  $wnd.__gwt_activeModules['lighthouse'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/lighthouse?user.agent=' + ua + '&_callback=' + callback;
